    ...
    <div class="container">
      ...
      <div class="card" :class="'priority-' + priority">
        <div class="card-inner">
          <!-- Card image -->
          <img
            class="card-img-top respoonsive"
            :src="randomImage"
            alt="Card image cap"
          />
          ...
          <div class="card-body">
            ...
            <div v-if="showInEdit" class="for-group">
              ...
              <select id="priority" class="form-control" v-model="priority">
                ...
                <option :selected="priority == 3" value="3"
                  >Medium Hight</option
                >
...
export default {
  ...
  methods: {
    submit() {
      ...
      if (valid) {
        const context = this.task.id
          ? this.context + this.task.id
          : this.context;
